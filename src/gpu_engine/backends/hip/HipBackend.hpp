#ifndef ELIPS_GPU_ENGINE_HIP_BACKEND_HPP
#define ELIPS_GPU_ENGINE_HIP_BACKEND_HPP

#ifdef ELIPS_HIP_ENABLED

#include "elips/gpu_engine/GpuPort.hpp"
#include <vector>

namespace elips::gpu::hip {

class HipBackend final : public GpuPort {
public:
    HipBackend();
    ~HipBackend() override;
