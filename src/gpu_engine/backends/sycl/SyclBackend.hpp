#ifndef ELIPS_GPU_ENGINE_SYCL_BACKEND_HPP
#define ELIPS_GPU_ENGINE_SYCL_BACKEND_HPP

#ifdef ELIPS_SYCL_ENABLED

#include "elips/gpu_engine/GpuPort.hpp"
#include <memory>
#include <vector>

namespace elips::gpu::sycl {

class SyclBackend final : public GpuPort {
public:
    SyclBackend();
